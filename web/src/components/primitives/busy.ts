 ...
 *
 * The indicator is decorative (`aria-hidden`) and animated only in CSS, with
 * the animation removed under `prefers-reduced-motion: reduce`. Content stays
 * visible and readable: a busy region is not a disabled one, and the primitive
